...
Обновление: Начиная с Houdini 20.5, стало возможным объявлять структуры в теле "врангла" используя блок из
препроцессорных директив `outer` и `endouter`. Смотри пример в разделе структуры.
